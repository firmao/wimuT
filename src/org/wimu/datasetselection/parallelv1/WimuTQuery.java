...
public class WimuTQuery {
	...
	Map<String, Long> mapAppTime = new HashMap<String, Long>();
	
	public Map<String, Long> getMapAppTime() {
		return mapAppTime;
	}
	public void setMapAppTime(Map<String, Long> mapAppTime) {
		this.mapAppTime = mapAppTime;
	}
